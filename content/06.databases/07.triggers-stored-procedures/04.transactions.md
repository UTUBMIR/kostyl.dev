...
flowchart TB
    ...
    Op1[UPDATE Account A<br/>-1000]
    Op2[UPDATE Account B<br/>+1000]
    
    Check{Помилка?}
    
    Commit[COMMIT<br/>Зберегти зміни]
    Rollback[ROLLBACK<br/>Відмінити ВСЕ]
    ...
    Rollback -.->|Повернути до<br/>першого стану| Start
