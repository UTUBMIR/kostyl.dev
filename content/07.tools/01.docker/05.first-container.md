...
![docker run hello-world command execution sequence flow chart](/images/tools/docker/first-container/01.png){.diagram-img}
...
![docker port mapping port forwarding host to container diagram](/images/tools/docker/first-container/02.png){.diagram-img}
