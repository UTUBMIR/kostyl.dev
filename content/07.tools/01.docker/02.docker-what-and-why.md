...
::concept-canvas{caption="Життєвий цикл: Build ➔ Ship ➔ Run" pattern="grid" steps="3" frame="macos" bg="dark"}
...
::concept-canvas{caption="Архітектура Docker: Клієнт-Сервер" pattern="grid" frame="macos" bg="white"}
...
::concept-canvas{caption="Порівняння архітектур: Docker vs Podman" pattern="dots" frame="macos" bg="dark"}
...
::concept-canvas{caption="Ієрархія офіційних образів .NET" pattern="dots" frame="macos" bg="soft"}
