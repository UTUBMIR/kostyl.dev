...
<div class="line"><span class="opacity-40">$</span> <strong>aws ecr get-login-password --region eu-central-1 | docker login --username AWS --password-stdin 123456789012.dkr.ecr.eu-central-1.amazonaws.com</strong></div>
...
<div class="line"><span class="opacity-40">$</span> <strong>aws ecr create-repository --repository-name my-api --region eu-central-1 --image-scanning-configuration scanOnPush=true</strong></div>
<div class="line">{</div>
