...
Створіть файл `core/exceptions.py`, де визначте базовий клас `DomainException` та специфічні виключення бізнес-логіки:
...
from core.exceptions import DomainException, ProjectNotFoundError, ForbiddenError
...
async def get_project(project_id: int):
    ...
    return {"id": project_id, "title": "Демонстраційний проєкт TaskForge"}
```
