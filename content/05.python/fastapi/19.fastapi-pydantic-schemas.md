...
Схема проекту (`schemas/project.py`):

```python [schemas/project.py]
# schemas/project.py
from datetime import datetime
...
Схема завдання (`schemas/task.py`):

```python [schemas/task.py]
# schemas/task.py
from datetime import datetime
from pydantic import BaseModel, Field, ConfigDict
from schemas.enums import TaskStatus, TaskPriority
