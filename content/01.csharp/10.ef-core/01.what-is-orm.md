...
graph TD
    subgraph "Presentation Layer"
        A["🌐 Controllers / Endpoints<br/>Razor Pages / Blazor"]
    end

    subgraph "Application Layer"
        B["📋 Application Services<br/>Command Handlers / Queries"]
    end

    subgraph "Domain Layer"
        C["📦 Domain Entities<br/>Order, Product, Customer"]
        D["🔄 Domain Services<br/>OrderService, PricingService"]
    end

    subgraph "Infrastructure Layer"
        E["🗄️ DbContext<br/>AppDbContext"]
        F["📁 Repositories<br/>IOrderRepository"]
        G["🔌 EF Core<br/>+ Database Provider"]
    end

    subgraph "Database"
        H[("💾 PostgreSQL<br/>SQL Server<br/>SQLite")]
    end
