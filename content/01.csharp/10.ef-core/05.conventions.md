...
```mermaid
graph LR
    A["⚙️ Вбудовані<br/>конвенції<br/>(найнижчий пріоритет)"]
    B["🏷️ Data Annotations<br/>[Key], [Required]<br/>[MaxLength], [Table]"]
    C["🔧 Fluent API<br/>modelBuilder.Entity()<br/>(найвищий пріоритет)"]
