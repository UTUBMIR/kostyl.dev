...
```mermaid
graph LR
    M0["InitialCreate<br/>(таблиці Products,<br/>Categories)"]
    M1["AddDiscount<br/>(ALTER TABLE Products<br/>ADD Discount)"]
    M2["AddOrdersTable<br/>(CREATE TABLE<br/>Orders, LineItems)"]
    M3["AddIndexOnEmail<br/>(CREATE INDEX<br/>IX_Users_Email)"]
