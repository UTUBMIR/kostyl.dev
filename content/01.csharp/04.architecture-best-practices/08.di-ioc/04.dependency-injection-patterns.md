...
```mermaid
graph TD
    Q{"Залежність<br/>обов'язкова?"}
    Q -->|Так| CI["✅ Constructor Injection<br/>recommended"]
    Q -->|Ні| Q2{"Потрібна<br/>тільки в<br/>одному методі?"}
    Q2 -->|Так| MI["⚠️ Method Injection<br/>[FromServices]"]
    Q2 -->|Ні| PI["⚠️ Property Injection<br/>з Null Object Pattern"]
