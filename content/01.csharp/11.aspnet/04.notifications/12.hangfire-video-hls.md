...
graph TD
    ...
    MASTER --> P360["📄 playlist_360p.m3u8<br/>(360p Variant)"]
    MASTER --> P720["📄 playlist_720p.m3u8<br/>(720p Variant)"]
    MASTER --> P1080["📄 playlist_1080p.m3u8<br/>(1080p Variant)"]
...
```mermaid
graph LR
    UPLOAD["📤 HTTP Upload<br/>/videos/upload"]
    A["Job 1<br/>📊 AnalyzeVideo<br/>(метадані, вибір якостей)"]
    B["Job 2<br/>🎬 Transcode 360p"]
    C["Job 3<br/>🎬 Transcode 720p"]
    D["Job 4<br/>🎬 Transcode 1080p"]
    E["Job 5<br/>📄 GenerateMasterPlaylist"]
