...
```mermaid
graph LR
    R["🔴 RED<br/>Написати тест, що провалюється<br/>Код ще не існує"]
    G["🟢 GREEN<br/>Написати мінімальний код<br/>щоб тест пройшов"]
    REF["🔵 REFACTOR<br/>Покращити код<br/>Без зміни поведінки"]
