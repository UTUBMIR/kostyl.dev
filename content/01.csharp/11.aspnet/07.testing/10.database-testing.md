...
graph LR
    subgraph "Стратегія 1"
        A1["EF InMemory<br/>Provider"]
        A2["❌ Без SQL<br/>❌ Без constraints<br/>✅ Швидко<br/>✅ Просто"]
    end

    subgraph "Стратегія 2"
        B1["SQLite<br/>in-memory"]
        B2["⚡ Майже SQL<br/>⚠️ Деякі відмінності<br/>✅ Без Docker<br/>✅ Швидко"]
    end

    subgraph "Стратегія 3"
        C1["Testcontainers<br/>(реальна БД)"]
        C2["✅ 100% реальна<br/>✅ Constraints<br/>✅ DB-specific features<br/>⚠️ Потрібен Docker"]
    end
