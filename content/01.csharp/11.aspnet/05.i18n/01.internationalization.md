...
```mermaid
graph LR
    REQ["HTTP Request<br/>Accept-Language: uk-UA"] --> MW["RequestLocalizationMiddleware"]
    MW --> SET["Thread.CurrentCulture = uk-UA<br/>Thread.CurrentUICulture = uk-UA"]
    SET --> HC["Handler code<br/>DateTime.Now.ToString() → '18.03.2026'<br/>1234.56m.ToString('C') → '1 234,56 ₴'"]
    SET --> LOC["IStringLocalizer<br/>'ValidationRequired' → 'Поле обовʼязкове'"]
