...
```mermaid
graph LR
    A["ContentControl<br/>.Content = HomeViewModel"] --> B{"WPF шукає<br/>DataTemplate"}
    B --> C["DataType=HomeViewModel?<br/>Знайдено!"]
    C --> D["Рендерить HomeView<br/>DataContext = HomeViewModel"]
