...
```mermaid
graph TB
    A["App.Resources<br/>(глобальний scope)"]
    B["Window.Resources<br/>(scope вікна)"]
    C["Panel.Resources<br/>(scope контейнера)"]
    D["Element.Resources<br/>(scope елемента)"]
    E["Системна тема WPF<br/>(DefaultStyle)"]
