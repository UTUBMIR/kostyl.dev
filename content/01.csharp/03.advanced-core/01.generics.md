...
```mermaid
graph TD
    A[Generic Type Definition<br/>List&lt;T&gt;] -->|Type Argument: int| B[Closed Constructed Type<br/>List&lt;int&gt;]
    A -->|Type Argument: string| C[Closed Constructed Type<br/>List&lt;string&gt;]
    A -->|No Type Argument| D[Open Constructed Type<br/>List&lt;T&gt;]
