...
```cpp [FindPuzzle.cpp] showLineNumbers
#include <iostream>
#include <string>
...
::terminal-preview{title="./FindPuzzle"}
...
```cpp [NposExample.cpp] showLineNumbers
#include <iostream>
#include <string>
...
::terminal-preview{title="./NposExample"}
...
```cpp [FindAllOccurrences.cpp] showLineNumbers
#include <iostream>
#include <string>
#include <vector>
...
::terminal-preview{title="./FindAllOccurrences"}
...
```cpp [StlVsStringSearch.cpp] showLineNumbers
#include <iostream>
#include <string>
...
::terminal-preview{title="./StlVsStringSearch"}
...
```cpp [ValidIdentifier.cpp] showLineNumbers
#include <iostream>
#include <string>
#include <cctype>
...
::terminal-preview{title="./ValidIdentifier"}
...
```cpp [SplitByDelimiter.cpp] showLineNumbers
#include <iostream>
#include <string>
#include <vector>
...
::terminal-preview{title="./SplitByDelimiter"}
...
```cpp [ConfigParser.cpp] showLineNumbers
#include <iostream>
#include <string>
#include <vector>
...
::terminal-preview{title="./ConfigParser"}
