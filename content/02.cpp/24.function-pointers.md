...
::terminal-preview{title="./Calculator" :expandable="true"}
<div class="line"><span class="opacity-40">$</span> <strong class="font-bold">./Calculator</strong></div>
<div class="line"><span class="text-blue-400 font-bold">=== Калькулятор ===</span></div>
<div class="line">Підтримувані операції: + - * /</div>
<div class="line">Введіть 'q' замість операції для виходу.</div>
<div class="line"></div>
<div class="line">Введіть: число1 операція число2</div>
<div class="line"><span class="opacity-40">&gt;</span> <strong>25 + 17</strong></div>
<div class="line"><span class="text-green-400 font-bold">25 + 17 = 42</span></div>
<div class="line"></div>
<div class="line">Введіть: число1 операція число2</div>
<div class="line"><span class="opacity-40">&gt;</span> <strong>100 / 4</strong></div>
<div class="line"><span class="text-green-400 font-bold">100 / 4 = 25</span></div>
<div class="line"></div>
<div class="line">Введіть: число1 операція число2</div>
<div class="line"><span class="opacity-40">&gt;</span> <strong>5 / 0</strong></div>
<div class="line"><span class="text-yellow-400 font-bold">Помилка: ділення на нуль!</span></div>
<div class="line"></div>
<div class="line">Введіть: число1 операція число2</div>
<div class="line"><span class="opacity-40">&gt;</span> <strong>7 % 3</strong></div>
<div class="line"><span class="text-rose-400">Невідома операція: %</span></div>
<div class="line"></div>
<div class="line">Введіть: число1 операція число2</div>
<div class="line"><span class="opacity-40">&gt;</span> <strong>q</strong></div>
<div class="line">До побачення!</div>
...
::tip
Зверніть увагу: якщо `OPERATION_COUNT` та обидва масиви `operationSymbols` і `operations` винести в окремий файл конфігурації або структуру, то додавання нової операції взагалі не вимагатиме зміни жодної функції з бізнес-логікою. Це і є справжня розширюваність.
::
