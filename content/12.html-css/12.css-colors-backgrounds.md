...
```mermaid
graph LR
    H["H — Hue (Відтінок)<br/>0°-360° на колірному колі<br/>0°=червоний 120°=зелений<br/>240°=синій 360°=червоний"] --> HSL["HSL-колір"]
    S["S — Saturation (Насиченість)<br/>0% = сірий<br/>100% = яскравий"] --> HSL
    L["L — Lightness (Яскравість)<br/>0% = чорний<br/>50% = чистий колір<br/>100% = білий"] --> HSL
