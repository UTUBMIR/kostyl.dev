...
```mermaid
graph BT
    A["@layer base<br/>(найнижчий пріоритет)<br/>нормалізація, reset"] --> B
    B["@layer components<br/>бібліотеки, UI-компоненти"] --> C
    C["@layer utilities<br/>функціональні класи"] --> D
    D["Стилі поза шарами<br/>(найвищий пріоритет)<br/>ваші перевизначення"]
