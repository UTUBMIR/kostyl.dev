...
graph TD
    ...
    Q -->|Іконка, схема, логотип| SVG[\"SVG<br/>Векторний формат<br/>Масштабується без втрат\"]
    Q -->|Анімація| GIF_W{\"Потрібна якість?\"}

    F -->|Ні| WEBP_J{\"Максимальна якість?\"}
    F -->|Так| WEBP_T[\"WebP або AVIF<br/>Прозорість + стиснення\"]

    WEBP_J -->|Так| JPEG[\"JPEG / WebP<br/>Добра якість та розмір\"]
    WEBP_J -->|Ні, мінімальний розмір| AVIF[\"AVIF<br/>Найкраще стиснення<br/>Менша підтримка\"]

    GIF_W -->|Якість важлива| WEBP_A[\"WebP (анімований)<br/>Замінює GIF\"]
    GIF_W -->|Не важлива| GIF[\"GIF<br/>Широка підтримка\"]
