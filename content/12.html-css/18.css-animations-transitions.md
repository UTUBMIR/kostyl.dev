...
```mermaid
flowchart LR
    JS["JavaScript"] --> Style["Style<br/>Обчислення стилів"]
    Style --> Layout["Layout<br/>Розрахунок розмірів<br/>та позицій"]
    Layout --> Paint["Paint<br/>Малювання пікселів"]
    Paint --> Composite["Composite<br/>Складання шарів"]
