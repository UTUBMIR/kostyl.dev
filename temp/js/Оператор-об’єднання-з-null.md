...
## [Порівняння з ||](https://uk.javascript.info/nullish-coalescing-operator#porivnyannya-z)

Оператор АБО `||` може бути використаний таким же чином, як `??`, як це було описано в [попередній главі](https://uk.javascript.info/logical-operators#or-finds-the-first-truthy-value).
...
## [Пріоритет](https://uk.javascript.info/nullish-coalescing-operator#prioritet)
...
### [Використання ?? разом з && або ||](https://uk.javascript.info/nullish-coalescing-operator#vikoristannya-razom-z-abo)
...
## [Підсумки](https://uk.javascript.info/nullish-coalescing-operator#pidsumki)
