...
_Цикл_ – це спосіб повторити один і той же код кілька разів.

## [Цикл “while”](https://uk.javascript.info/while-for#cikl-while)
...
Одне виконання циклу називається _ітерацією_. Цикл в зразку вище робить три ітерації.
...
Фігурні дужки не потрібні для однорядкової операції
...
Перевірка умови може бути переміщена _нижче_ тіла циклу використовуючи `do..while` синтаксис:
...
## [Цикл “for”](https://uk.javascript.info/while-for#cikl-for)
...
### [Пропуск частин в “for”](https://uk.javascript.info/while-for#propusk-chastin-v-for)
...
## [Переривання циклу: “break”](https://uk.javascript.info/while-for#pererivannya-ciklu-break)
...
## [Продовження з наступної ітерації](https://uk.javascript.info/while-for#continue)
...
Директива `continue` допомагає зменшити рівень вкладеності
...
## [Мітки для break/continue](https://uk.javascript.info/while-for#mitki-dlya-break-continue)
...
_Мітка_ складається з ідентифікатора та двокрапки перед циклом:
...
## [Підсумки](https://uk.javascript.info/while-for#pidsumki)
